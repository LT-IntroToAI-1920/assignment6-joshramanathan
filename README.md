...
author: Assignment written by Rett Bull, Pomona College with changes by Nathan Shelly and Sara Sood, Northwestern University.
date: 'Due Monday, May 21'
geometry: margin=1in
urlcolor: cyan
---
...
For this assignment, you will do some work at the python interpreter. Save a summary of what you do (python commands and all) in a file called `a6.py`. You will be submitting this file at the end. You can expect to do the bulk of the work on this assignment in class on Thursday.

You will be using the `neural.py` file that was included with this assignment. At the top of your file, be sure to include the following - `from neural import *`.
